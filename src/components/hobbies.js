...
export default class HobbiesComponent extends React.Component {
    ...
    constructor(props) {
        super(props);
        this.state = {hobbies: ["Playing piano","Playing soccer", "Cycling", "Playing snooker"]};
      }
    ...
    <Segment>
        ...
        <iframe title="Musescore" width="100%" height="394" src="https://musescore.com/user/156429/scores/5464246/embed" frameborder="0" allowfullscreen="" allow="autoplay; fullscreen"></iframe>
    </Segment> 
    )
    }
}